        ...
        <div class="container-fluid">
            ...
            <div class="card card-primary">
                ...
                <div class="card-footer">
                    <div class="btn-group">
                        <a href="<?php echo base_url('pengajuansub/closePengajuansub/ . $detail_pengajuansub->ajuanSUBID ') ?>" class="btn btn-primary btn-info" onclick="return confirm('Aapakah anda yakin closing pengajuan <?= $detail_pengajuansub->ajuan ?>')"><i class="fas fa-window-close">Close</i></a>
                    </div>
                    &nbsp;
                    <!-- <div class="btn-group">
              <a href="#" class="btn btn-primary btn"><i class="far fa-paper-plane"></i> Manage</a>
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        ...
                        <a data-target="#mObjekDigugat" data-toggle="modal" id="myObjekDigugat" class="dropdown-item" href="#myObjekDigugat" ajuanSUBID='<?= $detail_pengajuansub['ajuanSUBID'] ?>'> <i class="fas fa-chevron-circle-right"></i>Objek Digugat</a>
                        ...
                        <a data-target="#mResponKanwil" data-toggle="modal" class="dropdown-item" id="myResponKanwil" href="#myPengantarKPP" ajuanSUBID='<?= $detail_pengajuansub['ajuanSUBID'] ?>'> <i class="fas fa-chevron-circle-right"></i>Respon Kantor Wilayah</a>
                            ...
                            <tbody>
                                ...
                                foreach ($mketetapanpajaksub as $row) { ?>
                                    <tr>
                                        ...
                                        <td><?= $row['TETAPAJNilaiKetetapan']; ?></td>
                                    </tr>
                                <?php } ?>
                            </tbody>
                        </table>
            ...
            <div class="modal fade" id="KetetapanPajak" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <form action="<?php echo base_url() ?>/pengajuan/saveKetetapanPajakSub" method="post">
